...
let scrape = async () => {
    ...
    const result = await page.evaluate(() => {
        ...
        for (var element of elements) {
            let image = element.querySelector('#main > div > div:nth-child(4) > div > div > div.container > div.section-below-the-fold > div.section-recommend-products-wrapper > div > div > div.stardust-tabs-panels > section:nth-child(1) > div > div:nth-child(1) > a > div > div > div.n-CE6j.iR\+sxV > img').getAttribute('src');
            ...
            let price = element.querySelector('#main > div > div:nth-child(4) > div > div > div.container > div.section-below-the-fold > div.section-recommend-products-wrapper > div > div > div.stardust-tabs-panels > section:nth-child(1) > div > div:nth-child(1) > a > div > div > div.W3bJfG > div.imdVqB._2fuFWg > div.WSVId4.fepoRf > span.j0vBz2').innerText;
